                                                            ...
                                                            <div class="upload-area">
                                                                <div class="brows-file-wrapper" data-black-overlay="9">
                                                                    ...
                                                                    <img id="createfileImage"
                                                                        src="/e-cademy_assets/images/others/thumbnail-placeholder.svg"
                                                                        alt="file image">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="course-field mb--15">
                                                    ...
                                                    <div class="rbt-modern-select bg-transparent height-50 mb--10">
                                                        <select class="w-100" data-live-search="true"
                                                            title="English" multiple data-size="7"
                                                ...
                                                <ul class="rbt-default-tab-button nav nav-tabs" id="myTab"
                                                    ...
                                                    <li class="nav-item" role="presentation">
                                                        <a href="#" class="active" id="landscape-tab"
                                                            data-bs-toggle="tab" data-bs-target="#landscape"
                                                            role="tab" aria-controls="landscape"
                                                            aria-selected="true">
                                                            <span>Landscape</span>
                                                        </a>
                                                    </li>
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="certificate-inner rbt-image-checkbox">
                                                                        ...
                                                                        <label for="option1"><img
                                                                                src="/e-cademy_assets/images/icons/certificate-none.svg"
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="certificate-inner rbt-image-checkbox">
                                                                        ...
                                                                        <label for="option2"><img
                                                                                src="/e-cademy_assets/images/others/preview-01.png"
                                                                                alt="Certificate Image"></label>
                                                                    </div>
                                                                </div>
                                                                <!-- End Single Certificate  -->
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="certificate-inner rbt-image-checkbox">
                                                                        ...
                                                                        <label for="option3"><img
                                                                                src="/e-cademy_assets/images/others/preview-02.png"
                                                                                alt="Certificate Image"></label>
                                                                    </div>
                                                                </div>
                                                                <!-- End Single Certificate  -->
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="certificate-inner rbt-image-checkbox">
                                                                        ...
                                                                        <label for="option4"><img
                                                                                src="/e-cademy_assets/images/others/preview-03.png"
                                                                                alt="Certificate Image"></label>
                                                                    </div>
                                                                </div>
                                                                <!-- End Single Certificate  -->
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="certificate-inner rbt-image-checkbox">
                                                                        ...
                                                                        <label for="option5"><img
                                                                                src="/e-cademy_assets/images/others/preview-04.png"
                                                                                alt="Certificate Image"></label>
                                                                    </div>
                                                                </div>
                                                                <!-- End Single Certificate  -->
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="certificate-inner rbt-image-checkbox">
                                                                        ...
                                                                        <label for="option6"><img
                                                                                src="/e-cademy_assets/images/others/preview-05.png"
                                                                                alt="Certificate Image"></label>
                                                                    </div>
                                                                </div>
                                                                <!-- End Single Certificate  -->
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="certificate-inner rbt-image-checkbox">
                                                                        ...
                                                                        <label for="optionport1"><img
                                                                                src="/e-cademy_assets/images/icons/certificate-none-portrait.svg"
                                                                                alt="Certificate Image"></label>
                                                                    </div>
                                                                </div>
                                                                <!-- End Single Certificate  -->
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="certificate-inner rbt-image-checkbox">
                                                                        ...
                                                                        <label for="optionport2"><img
                                                                                src="/e-cademy_assets/images/others/preview-port-01.png"
                                                                                alt="Certificate Image"></label>
                                                                    </div>
                                                                </div>
                                                                <!-- End Single Certificate  -->
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="certificate-inner rbt-image-checkbox">
                                                                        ...
                                                                        <label for="optionport3"><img
                                                                                src="/e-cademy_assets/images/others/preview-port-02.png"
                                                                                alt="Certificate Image"></label>
                                                                    </div>
                                                                </div>
                                                                <!-- End Single Certificate  -->
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="certificate-inner rbt-image-checkbox">
                                                                        ...
                                                                        <label for="optionport4"><img
                                                                                src="/e-cademy_assets/images/others/preview-port-03.png"
                                                                                alt="Certificate Image"></label>
                                                                    </div>
                                                                </div>
                                                                <!-- End Single Certificate  -->
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="certificate-inner rbt-image-checkbox">
                                                                        ...
                                                                        <label for="optionport5"><img
                                                                                src="/e-cademy_assets/images/others/preview-port-05.png"
                                                                                alt="Certificate Image"></label>
                                                                    </div>
                                                                </div>
                                                                <!-- End Single Certificate  -->
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="certificate-inner rbt-image-checkbox">
                                                                        ...
                                                                        <label for="optionport6"><img
                                                                                src="/e-cademy_assets/images/others/preview-port-06.png"
                                                                                alt="Certificate Image"></label>
                                                                    </div>
                                                                </div>
                                                                <!-- End Single Certificate  -->
