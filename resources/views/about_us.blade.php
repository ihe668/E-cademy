                ...
                <div class="col-lg-10 offset-lg-1">
                    <div class="content">
                        <div class="inner text-center">
                            ...
                            <p class="description has-medium-font-size mt--20">Dive in and learn from zero to mastery and way more.!
                            </p>
                            <div class="slider-btn rbt-button-group justify-content-center">
                                ...
                                <a class="rbt-btn hover-icon-reverse btn-white" href="{{ route('contact_us') }}">
                                    <span class="icon-reverse-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="video-popup-wrapper">
                        <img class="w-100 rbt-radius" src="/e-cademy_assets/images/bg/bg-image-12.jpg" alt="Video Images">
    ...
    <div class="rbt-about-area about-style-1 bg-color-white rbt-section-gap">
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6">
                    <div class="content">
                        <img src="/e-cademy_assets/images/about/about-06.png" alt="About Images">
                    </div>
                </div>
                <div class="col-lg-6" data-sal="slide-up" data-sal-duration="700">
                    <div class="inner pl--50 pl_sm--5">
                        <div class="content text-start">
                            <span class="rbt-badge-6 bg-primary-opacity">About E-cademy</span>
                            <h3 class="title">Welcome to E-cademy where you can develop your skills with the  best Online courses.</h3>
                            <p class="description mt--30"><strong>E-cademy educational platform</strong> Join To Expand Your Knowledge</p>
                ...
                <div class="row g-5 align-items-center content-wrapper">
                    ...
                    <div class="col-xxl-6 col-xl-6 col-lg-6">
                        <div class="inner-content text-start">
                            <p class="color-white">Apply for Admission in Post Graduate Diploma. Application Deadline: 26th September 2023 · Undergraduate & Graduate Admission: Fall 2023 Semester · 20% Waiver on ...
                            </p>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-xl-3 col-lg-6">
            ...
            <div class="row row--15 mt_dec--30">
                ...
                <div class="col-lg-4 col-xl-3 col-xxl-3 col-md-6 col-sm-6 col-12 mt--30">
                    <div class="service-card service-card-6">
                        <div class="inner">
                            <div class="icon">
                                <img src="/e-cademy_assets/images/icons/001-bulb.png" alt="icons Images">
                            </div>
                            <div class="content">
                ...
                <div class="col-lg-4 col-xl-3 col-xxl-3 col-md-6 col-sm-6 col-12 mt--30">
                    <div class="service-card service-card-6">
                        <div class="inner">
                            <div class="icon">
                                <img src="/e-cademy_assets/images/icons/002-hat.png" alt="Shape Images">
                            </div>
                            <div class="content">
                ...
                <div class="col-lg-4 col-xl-3 col-xxl-3 col-md-6 col-sm-6 col-12 mt--30">
                    <div class="service-card service-card-6">
                        <div class="inner">
                            <div class="icon">
                                <img src="/e-cademy_assets/images/icons/003-id-card.png" alt="Shape Images">
                            </div>
                            <div class="content">
                ...
                <div class="col-lg-4 col-xl-3 col-xxl-3 col-md-6 col-sm-6 col-12 mt--30">
                    <div class="service-card service-card-6">
                        <div class="inner">
                            <div class="icon">
                                <img src="/e-cademy_assets/images/icons/004-pass.png" alt="Shape Images">
                            </div>
                            <div class="content">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="rbt-team-modal-thumb nav nav-tabs">
                        <a class="rbt-team-thumbnail" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            <div class="thumb">
                                <img src="/e-cademy_assets/images/team/team-05.jpg" alt="Testimonial Images">
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="rbt-team-modal-thumb nav nav-tabs">
                        <a class="rbt-team-thumbnail" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            <div class="thumb">
                                <img src="/e-cademy_assets/images/team/team-09.jpg" alt="Testimonial Images">
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="rbt-team-modal-thumb nav nav-tabs">
                        <a class="rbt-team-thumbnail" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            <div class="thumb">
                                <img src="/e-cademy_assets/images/team/team-03.jpg" alt="Testimonial Images">
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="rbt-team-modal-thumb nav nav-tabs">
                        <a class="rbt-team-thumbnail" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            <div class="thumb">
                                <img src="/e-cademy_assets/images/team/team-07.jpg" alt="Testimonial Images">
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-12">
                    <div class="rbt-team-modal-thumb nav nav-tabs">
                        <a class="rbt-team-thumbnail" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            <div class="thumb">
                                <img src="/e-cademy_assets/images/team/team-01.jpg" alt="Testimonial Images">
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-12">
                    <div class="rbt-team-modal-thumb nav nav-tabs">
                        <a class="rbt-team-thumbnail" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            <div class="thumb">
                                <img src="/e-cademy_assets/images/team/team-02.jpg" alt="Testimonial Images">
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-12">
                    <div class="rbt-team-modal-thumb nav nav-tabs">
                        <a class="rbt-team-thumbnail" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            <div class="thumb">
                                <img src="/e-cademy_assets/images/team/team-04.jpg" alt="Testimonial Images">
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-12">
                    <div class="rbt-team-modal-thumb nav nav-tabs">
                        <a class="rbt-team-thumbnail" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            <div class="thumb">
                                <img src="/e-cademy_assets/images/team/team-06.jpg" alt="Testimonial Images">
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-12">
                    <div class="rbt-team-modal-thumb nav nav-tabs">
                        <a class="rbt-team-thumbnail" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            <div class="thumb">
                                <img src="/e-cademy_assets/images/team/team-08.jpg" alt="Testimonial Images">
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-12">
                    <div class="rbt-team-modal-thumb nav nav-tabs">
                        <a class="rbt-team-thumbnail" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            <div class="thumb">
                                <img src="/e-cademy_assets/images/team/team-10.jpg" alt="Testimonial Images">
                            </div>
                        </a>
                    </div>
                </div>
                                ...
                                <div class="row g-5 row--30 align-items-center">
                                    <div class="col-lg-4">
                                        <div class="rbt-team-thumbnail">
                                            <div class="thumb">
                                                <img class="w-100" src="/e-cademy_assets/images/team/team-09.jpg" alt="Testimonial Images">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-8">
