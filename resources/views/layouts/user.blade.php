...
<!-- Mirrored from rainbowit.net/html/histudy/student-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 May 2023 14:00:08 GMT -->
...
<head>
 ...
 ============================================ -->
    ...
    <link rel="stylesheet" href="/e-cademy_assets/css/plugins/sal.css">
    <link rel="stylesheet" href="/e-cademy_assets/css/plugins/feather.css">
    <link rel="stylesheet" href="/e-cademy_assets/css/plugins/fontawesome.min.css">
    <link rel="stylesheet" href="/e-cademy_assets/css/plugins/euclid-circulara.css">
    <link rel="stylesheet" href="/e-cademy_assets/css/plugins/swiper.css">
    <link rel="stylesheet" href="/e-cademy_assets/css/plugins/magnify.css">
    <link rel="stylesheet" href="/e-cademy_assets/css/plugins/odometer.css">
    <link rel="stylesheet" href="/e-cademy_assets/css/plugins/animation.css">
    <link rel="stylesheet" href="/e-cademy_assets/css/plugins/bootstrap-select.min.css">
    <link rel="stylesheet" href="/e-cademy_assets/css/plugins/jquery-ui.css">
    <link rel="stylesheet" href="/e-cademy_assets/css/plugins/magnigy-popup.min.css">
    <link rel="stylesheet" href="/e-cademy_assets/css/plugins/plyr.css">
    <link rel="stylesheet" href="/e-cademy_assets/css/style.css">
</head>
...
<body>
    ...
    <header class="rbt-header rbt-header-10">
                                        ...
                                        <div class="inner">
                                            <div class="content">
                                                ...
                                                <span class="news-text"><img
                                                        ...
                                                        alt="Hand Emojji Images"> Intro price. Get Histudy for Big Sale
                                                    -95% off.</span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <li class="has-child-menu">
                                            ...
                                            <ul class="sub-menu">
                                                <li>
                                                    <a href="#">
                                                        <img class="left-image"
                                                            src="/e-cademy_assets/images/icons/fr.png"
                                                            alt="Language Images">
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="left-image"
                                                            src="/e-cademy_assets/images/icons/de.png"
                                                            alt="Language Images">
        ...
        <div class="rbt-page-banner-wrapper">
            ...
            <div class="rbt-banner-image img-fluid"></div>
            <!-- End Banner BG Image  -->
        </div>
        <!-- Start Card Style -->
...
============================================ -->
        <!-- Modernizer JS -->
        <script src="/e-cademy_assets/js/vendor/modernizr.min.js"></script>
        <!-- jQuery JS -->
        <script src="/e-cademy_assets/js/vendor/jquery.js"></script>
        <!-- Bootstrap JS -->
        <script src="/e-cademy_assets/js/vendor/bootstrap.min.js"></script>
        <!-- sal.js -->
        <script src="/e-cademy_assets/js/vendor/sal.js"></script>
        <script src="/e-cademy_assets/js/vendor/swiper.js"></script>
        <script src="/e-cademy_assets/js/vendor/magnify.min.js"></script>
        <script src="/e-cademy_assets/js/vendor/jquery-appear.js"></script>
        <script src="/e-cademy_assets/js/vendor/odometer.js"></script>
        <script src="/e-cademy_assets/js/vendor/backtotop.js"></script>
        <script src="/e-cademy_assets/js/vendor/isotop.js"></script>
        <script src="/e-cademy_assets/js/vendor/imageloaded.js"></script>

        <script src="/e-cademy_assets/js/vendor/wow.js"></script>
        <script src="/e-cademy_assets/js/vendor/waypoint.min.js"></script>
        <script src="/e-cademy_assets/js/vendor/easypie.js"></script>
        <script src="/e-cademy_assets/js/vendor/text-type.js"></script>
        <script src="/e-cademy_assets/js/vendor/jquery-one-page-nav.js"></script>
        <script src="/e-cademy_assets/js/vendor/bootstrap-select.min.js"></script>
        <script src="/e-cademy_assets/js/vendor/jquery-ui.js"></script>
        <script src="/e-cademy_assets/js/vendor/magnify-popup.min.js"></script>
        <script src="/e-cademy_assets/js/vendor/paralax-scroll.js"></script>
        <script src="/e-cademy_assets/js/vendor/paralax.min.js"></script>
        <script src="/e-cademy_assets/js/vendor/countdown.js"></script>
...
<!-- Mirrored from rainbowit.net/html/histudy/student-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 May 2023 14:00:09 GMT -->
